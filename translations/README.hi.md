...
**173 डिफ़ॉल्ट नियम · 17 मूल्यांकक · शून्य नेटवर्क कॉल · Apache 2.0**
...
- **गहन सुरक्षा:** विस्तार योग्य नीति परतें: 17 निर्धारक मूल्यांकक और वैकल्पिक सेमांटिक लेयर (दूसरा LLM); PII डिटेक्शन, कॉन्फ़िग इंटीग्रिटी जांच, और इंजेक्शन डिटेक्शन
...
नियमों से पहले मूल्यांकित। 21 अंतर्निहित श्रेणियाँ, प्रत्येक समर्पित निष्कर्षण तर्क के साथ। श्रेणियाँ: `tools`, `extensions`, `paths`, `commands`, `domains`, `mcp_servers`, और अधिक। `lanekeep policy` से या डैशबोर्ड में **Governance** टैब से टॉगल करें।
